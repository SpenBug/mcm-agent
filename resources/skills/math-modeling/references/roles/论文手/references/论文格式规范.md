...
- 华为杯（中国研究生数学建模竞赛）：`https://www.cmathc.org.cn/cpmcm/`，当届已整理的规范见 `../../../华为杯官方规范-2026.md`

> 华为杯的篇幅约束与 CUMCM 不同：官方只规定**摘要不超过两页**；在已核验的 2026 届四份官方文件中**未见正文页数上限**。另外摘要页从"1"开始编页码、论文不能有页眉、首页封皮的 4 个 logo 不能替换。以 `华为杯官方规范-2026.md` 为准，禁止套用 CUMCM 的 30 页或一页摘要。
